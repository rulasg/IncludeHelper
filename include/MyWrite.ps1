# {"Version":"1.4.0","Date":"2026-06-25","Source":"IncludeHelper","HeaderVersion":1}
...
function Write-MyDebug {
    ...
    process{
        ...
        if (Test-MyDebug -section $section) {
            ...
            if ($Object) {
                $objString = $Object | Get-ObjetString -Depth $objectDepth
...
function Get-ObjetString {
    ...
    process{
        ...
        return $Object | ConvertTo-Json -Depth $Depth -ErrorAction SilentlyContinue
    }
}
